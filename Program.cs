...
namespace DIO.Series
{
    class Program
    {
        ...
        // TO DO Verificar se foi digitados apenas números
        ...
        {
            Console.Write("Digite o id da série para ser excluida: ");
            int indiceSerie = int.Parse(Console.ReadLine());

            Console.Write("Tem certeza que deseja excluir a série ? [S / N]: ");
            var resposta = Console.ReadLine();
            while (resposta.ToUpper() != "S" && resposta.ToUpper() != "N")
            {
                Console.Write("Por favor digite um opção válida. [S / N]: ");
